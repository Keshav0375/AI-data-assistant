...
# Title
st.title("AI Data Assistant for Data Science 📢")

# Welcoming message
st.write("Hello 👋, I am you AI assistant and I am here to help you with data science projects")
...
with st.sidebar:
    ...
    st.caption("**You may already know that every exciting data science journey starts with a dataset."
               ...
               "we'll dive into understanding it and have some fun exploring it. "
               "Then, we'll work together to shape your business challenge into a data science framework. "
               "I'll introduce you to the coolest machine learning models, "
               "and we'll use them to tackle your problem. Sounds fun right**")
    st.divider()
    st.caption("<p style = 'text-align:center'> Made with love by Keshav</p>", unsafe_allow_html=True)
...
if st.session_state.clicked[1]:
    ...
    if user_csv is not None:
        ...
        def function_question_variable():
            ...
            summary_statistics=pandas_agent.invoke(f"Give me summary of statistics of {user_question_variable}")
